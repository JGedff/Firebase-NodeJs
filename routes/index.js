...
router.get("/newUser", async (req, res) => {
    ...
    if (req.query.imgUser != '') {
        ...
        userImg = `https://firebasestorage.googleapis.com/v0/b/YOUR FIREBASE APP.appspot.com/o/profileImg%2F${req.query.imgUser}?alt=media&token=${randomTocken}`;
    }
    else {
        userImg = 'DEFAULT PROFILE IMAGE';
    }
...
router.get("/newPost/:user/send", async (req, res) => {
    ...
    if (req.query.media != '') {
        ...
        postImg = `https://firebasestorage.googleapis.com/v0/b/YOUR FIREBASE APP.appspot.com/o/profileImg%2F${req.query.imgUser}?alt=media&token=${randomTocken}`;
...
router.get("/search/search", async (req, res) => {
    ...
    if (req.query.collection == "posts") {
        ...
        return res.redirect("/NOT-FOUND/QUERRY-ERROR");
    }
})
...
router.get("/search/admin", async (req, res) => {
    ...
    res.render("search/searchAdmin", { layout: "admin", dates, categories });
})

router.get("/search/admin/search", async (req, res) => {
    ...
    if (req.query.collection == "posts") {
        if (req.query.field == "undefined") {
            ...
            return res.render("search/resultSearchAdmin", { layout: "admin", posts });
        }
        else if (req.query.field == "userName" || req.query.field == "email" || req.query.field == "title" || req.query.field == "content") {
            const query = await postsCollection.orderBy(req.query.field).startAt(req.query.value).endAt(req.query.value + '\uf8ff').get()
        ...
        if (req.query.field == "undefined") {
            ...
            return res.render("search/resultSearchAdmin", { layout: "admin", users });
        }
        else if (req.query.field == "name" || req.query.field == "email" || req.query.field == "userDescription") {
            const query = await usersCollection.orderBy(req.query.field).startAt(req.query.value).endAt(req.query.value + '\uf8ff').get()
        ...
        return res.render("search/resultSearchAdmin", { layout: "admin", categories });
    }
    else if (req.query.collection == "date") {
        ...
        return res.render("search/resultSearchAdmin", { layout: "admin", dates });
    }
    else {
        console.log(req.query);
        return res.redirect("/NOT-FOUND/ERROR", { layout: "admin" });
    }
})
...
router.get("/users/admin", async (req, res) => {
    ...
    res.render("admin/seeCollection", { layout: "admin", users });
})
...
router.get("/posts/admin", async (req, res) => {
    ...
    res.render("admin/seeCollection", { layout: "admin", posts });
})
...
router.get("/comments/admin", async (req, res) => {
    ...
    res.render("admin/seeCollection", { layout: "admin", comments });
})
...
router.get("/categories/admin", async (req, res) => {
    ...
    res.render("admin/seeCollection", { layout: "admin", categories });
})

router.get("/dates/admin", async (req, res) => {
    ...
    res.render("admin/seeCollection", { layout: "admin", dates });
})

router.get("/users/admin/edit", async (req, res) => {
    ...
    res.render("admin/editUsers", { layout: "admin", user });
})

router.get("/posts/admin/edit", async (req, res) => {
    const query = await postsCollection.get();
    let counter = 0;
    ...
    res.render("admin/editPosts", { layout: "admin", post });
})

router.get("/comments/admin/edit", async (req, res) => {
    ...
    res.render("admin/editComments", { layout: "admin", comment });
})

router.get("/categories/admin/edit", async (req, res) => {
    const categories = await categoriesCollection.get();
    let counter = 0;
    ...
    res.render("admin/editCategories", { layout: "admin", category });
})

router.get("/dates/admin/edit", async (req, res) => {
    ...
    res.render("admin/editDates", { layout: "admin", dates });
})

router.get("/users/admin/edit/:id", async (req, res) => {
    const userData = await usersCollection.doc(req.params.id).get();

    res.render("admin/edit/users", { layout: "admin", doc: { ...userData.data() } });
})

router.get("/posts/admin/edit/:id", async (req, res) => {
    ...
    res.render("admin/edit/posts", { layout: "admin", doc: { ...posts.data() }, dates, categories });
})

router.get("/comments/admin/edit/:id", async (req, res) => {
    const comments = await comentsCollection.doc(req.params.id).get();

    res.render("admin/edit/comments", { layout: "admin", doc: { ...comments.data() } });
})

router.get("/categories/admin/edit/:id", async (req, res) => {
    const category = await categoriesCollection.doc(req.params.id).get();

    res.render("admin/edit/categories", { layout: "admin", doc: { ...category.data() } });
})

router.get("/dates/admin/edit/:id", async (req, res) => {
    const data = await categoriesCollection.doc(req.params.id).get();

    res.render("admin/edit/dates", { layout: "admin", doc: { id: req.params.id ,...data.data() } });
})

router.get("/users/admin/update/:id", async (req, res) => {
    const userData = {};
    let changeId = false;
    ...
    if (req.query.image != '') {
        ...
        userImg = `https://firebasestorage.googleapis.com/v0/b/YOUR FIREBASE APP.appspot.com/o/profileImg%2F${req.query.image}?alt=media&token=${randomTocken}`;
    }
    ...
    if (changeId) {
        ...
        usersCollection.doc(req.query.id).update(userData);
    }

    res.redirect("/users/admin");
})

router.get("/posts/admin/update/:id", async (req, res) => {
    const postData = {
        category: req.query.category,
        date: req.query.date
    };
    ...
    if (req.query.media != '') {
        ...
        userImg = `https://firebasestorage.googleapis.com/v0/b/YOUR FIREBASE APP.appspot.com/o/profileImg%2F${req.query.media}?alt=media&token=${randomTocken}`;
...
router.get("/comments/admin/update/:id", async (req, res) => {
    const comentData = {}
    let changeId = false;
    ...
    res.redirect("/comments/admin");
})

router.get("/categories/admin/update/:id", async (req, res) => {
    const category = {};
    let changeId = false;
...
router.get("/dates/admin/update/:id", async (req, res) => {
    const data = {}
    let changeId = false;
    ...
    res.redirect("/dates/admin");
})

router.get("/users/admin/delete/:id", async (req, res) => {
    const user = usersCollection.doc(req.params.user);
...
router.get("/posts/admin/delete/:id", async (req, res) => {
    const query = await comentsCollection.where("post", "==", req.params.id).get(); 
    const post = await postsCollection.doc(req.params.id).get();
...
router.get("/comments/admin/delete/:id", async (req, res) => {
    const dataComment = await comentsCollection.doc(req.params.id).get();
...
router.get("/categories/admin/delete/:id", async (req, res) => {
    await categoriesCollection.doc(req.params.id).delete();

    res.redirect("/categories/admin");
})

router.get("/dates/admin/delete/:id", async (req, res) => {
    await dateCollection.doc(req.params.id).delete();

    res.redirect("/dates/admin");
})

router.get("/posts/admin/create", async (req, res) => {
    ...
    res.render("admin/create/posts", { layout: "admin", categories, dates });
})

router.get("/comments/admin/create", async (req, res) => {
    res.render("admin/create/comments", { layout: "admin" });
})

router.get("/users/admin/create", async (req, res) => {
    res.render("admin/create/users", { layout: "admin" });
})

router.get("/categories/admin/create", async (req, res) => {
    res.render("admin/create/categories", { layout: "admin" });
})

router.get("/dates/admin/create", async (req, res) => {
    res.render("admin/create/dates", { layout: "admin" });
})

router.get("/posts/admin/create/send", async (req, res) => {
    let changeId = false;
    ...
    res.redirect("/posts/admin", { layout: "admin" });
})

router.get("/comments/admin/create/send", async (req, res) => {
    const dataComment = {
        content: req.query.content,
        post: req.query.post,
        userId: req.query.userId,
    ...
    res.redirect("/comments/admin", { layout: "admin" });
})

router.get("/users/admin/create/send", async (req, res) => {
    let changeId = false;
    let password = Buffer.from(req.query.passwd.trim(), 'base64url').toString();
    const dataUser = {
        email: req.query.email,
    ...
    if (req.query.image != '') {
        ...
        userImg = `https://firebasestorage.googleapis.com/v0/b/YOUR FIREBASE APP.com/o/profileImg%2F${req.query.image}?alt=media&token=${randomTocken}`;
    }
    else {
        userImg = 'DEFAULT PROFILE IMAGE';
    }
    ...
    res.redirect("/users/admin", { layout: "admin" });
})

router.get("/categories/admin/create/send", async (req, res) => {
    let changeId = false;
    const dataCategory = {
        name: req.query.name
    }
    ...
    res.redirect("/categories/admin", { layout: "admin" })
})

router.get("/dates/admin/create/send", async (req, res) => {
    const dateDoc = {
        date: req.query.date,
    ...
    res.redirect("/dates/admin", { layout: "admin" });
})
